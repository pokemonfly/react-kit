...
export default ( initialState = {}, reducers = {}, sagas = [] ) => {
    // Middlewares Build the middleware for intercepting and dispatching navigation actions
    ...
    const store = createStore( combineReducers( {
        ...
        ...reducers
    } ), initialState, composeEnhancers( applyMiddleware( ...middleware ), ...enhancers ) )
    store.asyncSagas = {}
    store.asyncReducers = {}
    store.runSaga = ( saga ) => {
